"""
python robolab/scripts/mujoco/sim2sim_f1_parkour.py --depth_encoder --actor --mujoco_xml robolab/data/robots/f1/f1_stairs.xml
"""
...
_CAMERA_OFFSET_POS_BODY = np.array(
    [0.15, 0.0, 0.25],
    dtype=np.float64,
)

_CAMERA_OFFSET_QUAT_WXYZ = np.array(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="F1 parkour sim2sim (depth_encoder.onnx + actor.onnx).")
    default_export = (
    ...
    mjcf_dir = f"{ISAAC_DATA_DIR}/robots/f1"
    scene_xml = {
        "stairs": f"{mjcf_dir}/f1_stairs.xml",
        "terrain": f"{mjcf_dir}/f1_terrain.xml",
        "plane": f"{mjcf_dir}/scene_f1_1.xml",
    }
    if args.mujoco_xml:
        ...
        class robot_config:
            ...
            default_pos = np.array(
                [
                    ...
                    # elbow, wrist_roll, wrist_yaw, wrist_pitch
